...
const siteData = deserializeFunctions(JSON.parse('{"lang":"en-US","dir":"ltr","title":"ginlon的定义域","description":"A VitePress site","base":"/","head":[],"appearance":true,"themeConfig":{"logo":"/avatar.jpg","nav":[{"text":"首页","link":"/"},{"text":"文章","link":"/blog/"},{"text":"日志","link":"/journal/"},{"text":"关于","link":"/author/"}],"search":{"provider":"local"},"sidebar":{"/blog/":[{"text":"实践","items":[{"text":"搭建阿里云服务器","link":"/blog/practice/搭建阿里云服务器.md"},{"text":"我的响应式是如何丢掉的","link":"/blog/practice/我的响应式是如何丢掉的.md"},{"text":"前端项目搭建","link":"/blog/practice/前端项目搭建.md"}]},{"text":"笔记","items":[{"text":"CSS 基础知识","link":"/blog/notes/CSS基础知识.md"},{"text":"页面性能优化","link":"/blog/notes/页面性能优化.md"}]}],"/journal":[]},"socialLinks":[{"icon":"github","link":"https://github.com/Gao-Jinlong"}]},"locales":{},"scrollOffset":90,"cleanUrls":false}'));
